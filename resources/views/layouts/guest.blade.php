                                ...
                                <li class="menu-item menu-item-has-children parent">
                                    ...
                                    <ul class="submenu curency">
                                        ...
                                        @auth
                                            ...
                                            <li class="menu-item menu-item-has-children parent">
                                                <a title="Myaacount" href="#">My Account ({{ Auth::user()->name }})<i class="fa fa-angle-down" aria-hidden="true"></i></a>
                                                <ul class="submenu curency">
                                                    <li class="menu-item">
                    ...
                    <ul>
                        <li class="fc-info-item">
                            ...
                            <div class="wrap-left-info">
                                ...
                                <p class="fc-desc">Free On Oder Over LKR 99</p>
                            </div>
                                    ...
                                    <div class="wrap-contact-detail">
                                        <ul>
                                            <li>
                                                ...
                                                <p class="contact-txt">4500 Grand Central Terminal New York,NY 1017 United State USA</p>
                                            </li>
                                            <li>
            ...
            <div class="coppy-right-box">
                <div class="container">
                    <div class="coppy-right-item item-left">
                        <p class="coppy-right-text">Copyright © 2020 1 Media. All rights reserved</p>
                    </div>
