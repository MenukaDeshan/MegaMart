            ...
            <form wire:submit.prevent="placeOrder" onsubmit="$('#processing').show();">
                ...
                <div class="summary summary-checkout">
                    <div class="summary-item payment-method">
                        ...
                        <div class="choose-payment-methods">
                            ...
                            <label class="payment-method">
                                ...
                                <span class="payment-desc" style="color: red">Coming Soon</span>
                            </label>
                            @error('paymentmode')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        @if ($errors->isEmpty())
                            <div wire:ignore id="processing" style="font-size: 22px; margin-bottom: 20px; padding-left: 37px; color:#0E0D40;  display: none;                   ">
                    ...
                    <div class="summary-item shipping-method">
                        ...
                        <p class="summary-info"><span class="title">Fixed LKR 0</span></p>
                    </div>
                </div>
            </form>
        </div>
