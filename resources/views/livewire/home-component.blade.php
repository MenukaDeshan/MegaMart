<main id="main">
	<div class="container">
			...
			<div class="wrap-main-slide">
				<div class="slide-carousel owl-carousel owl-carousel-main style-nav-1" data-items="1" data-loop="1" data-nav="true" data-dots="false">
				...
				<div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container " data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
					...
					<div class="product product-style-2 equal-elem ">
						...
						<div class="product-info">
							...
							<div class="wrap-price"><ins><p class="product-price">LKR {{$sproduct->sale_price}}</p></ins> <del><p class="product-price"Lkr{{$sproduct->regular_price}}</p></del></div>
						</div>
					</div>
					@endforeach
			...
			<div class="wrap-show-advance-info-box style-1">
				...
				<div class="wrap-top-banner">
					<a href="#" class="link-banner banner-effect-2">
						<figure><img src="{{asset('assets/images/ban.png')}}" width="1170" height="240" alt=""></figure>
					</a>
				</div>
                            ...
                            <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}' >
                                ...
                                <div class="product product-style-2 equal-elem ">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="wrap-price"><span class="product-price">LKR {{$c_product->regular_price}}</span></div>
                                    </div>
                                </div>
                                @endforeach
                            </div>
