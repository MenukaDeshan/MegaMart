...
<body class="home-page home-01 ">
												...
												@if(Auth::user()->utype==="ADM")
													<li class="menu-item menu-item-has-children parent" >
														...
														<ul class="submenu curency" >
															...
															<li class="menu-item">
																<a title="Contact Us" href="{{ route('admin.contact') }}">Contact Message</a>
															</li>
															<li class="menu-item">
													...
													<li class="menu-item menu-item-has-children parent">
														<a title="Myaacount" href="#">My Account
														...
														<ul class="submenu curency">
															...
															<li class="menu-item">
																<a title="All Coupons" href="/coupons">All Coupons</a>
															</li>
															<li class="menu-item">
																<a href="{{ route('logout') }}"
	...
	<script src="https://cdn.tiny.cloud/1/j30pdgje6k4p08r1xfd6e0u18w1kx9629ufx9gk2d6zulsfc/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>
